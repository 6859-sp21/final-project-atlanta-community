...
- Yuebin: he generated the idea of the circle packing graph and implemented the circle graph as well as the second bar chart. He also designed and implemented the project page and the scrolly telling application page framework then integrated others' work into it and adjust the visual encoding accordingly. Finally, he wrote the future work section of the paper.
