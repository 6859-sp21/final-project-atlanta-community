    ...
    >
      ...
      >
        <div class="content">
          ...
          <b-button class="button-blue" href="https://github.com/6859-sp21/final-project-atlanta-community/blob/main/final/FinalPaper.pdf" variant="primary">Go to the Full Paper</b-button>
