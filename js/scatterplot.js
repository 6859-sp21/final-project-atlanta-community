...
d3.csv("./data/filtered_data.csv", function(data) {
    ...
    var social_factors = ["community_size", "female_gender_ratio", "language_shift",]
  ...
  svg.append('g')
    ...
    .enter()
    .append("circle")
      .attr("cx", function (d) { return x(d['community_size']); } )
      .attr("cy", function (d) { return y(d['lexical_change']); } )
      .attr("r", 4)
      .style("fill", "#69b3a2")
      .style("opacity", 0.3)
      .style("stroke", "white")
